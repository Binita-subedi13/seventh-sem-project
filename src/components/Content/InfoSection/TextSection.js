...
<div className="basis-1/2 bg-slate-100 transition duration-150 p-8">
          ...
          <p className="text-justify w-10/12 pt-5 text-lg">
            ...
            dolorem! <br></br>
            <button className="bg-orange-500 text-lg font-medium border-orange-500 mt-5 py-2 px-4 hover:bg-white border-2 hover:border-black transition duration-200">Show more..</button>
          </p>
        </div>
    )
}
